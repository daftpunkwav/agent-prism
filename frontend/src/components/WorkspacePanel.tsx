...
export function WorkspacePanel({ workspaceName, pollInterval = 2000 }: WorkspacePanelProps) {
  ...
  }, [workspaceName, selectedFile, editContent, loadFiles, newReadAbort, showToast]);
  ...
  }, [workspaceName, newFileName, loadFiles, loadFile, newReadAbort, showToast]);
  ...
  const deleteFile = useCallback(
    ...
    [workspaceName, selectedFile, loadFiles, newReadAbort, showToast],
  );
